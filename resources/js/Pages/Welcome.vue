            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-5 lg:grid-cols-3">
                    ...
                    <nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end">
                        <Link :href="route('koica164_time')" class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                            KOICA 164 time
                        </Link>
                    ...
                    <div class="col-span-2 lg:col-span-3 flex justify-center space-x-4 mt-2">
                ...
                <main class="bg-[url('/images/thedsaban.jpg')] bg-cover bg-center min-h-screen relative">
                </main>
